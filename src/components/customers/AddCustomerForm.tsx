    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="glass-card max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-xl p-6">
            <h3 className="font-heading text-xl text-white">Ny kund</h3>
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-white">Företag</label>
                <input
                  type="text"
                  value={form.company}
              ...
              <div>
                <label className="block text-sm font-medium text-white">Födelsedag</label>
                <input
                  type="date"
                  value={form.birthday}
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-white">Avtalsvärde (kr)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-white">Avtalsstart</label>
                  <input
                    type="date"
                ...
                <div>
                  <label className="block text-sm font-medium text-white">Avtalslut</label>
                  <input
                    type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-white">Tjänster</label>
              ...
              <div>
                <label className="block text-sm font-medium text-white">Anteckningar</label>
                <textarea
                  value={form.notes}
